...
| Quality findings | **171** — 11 reject, 160 warn |
| **Labelled anomalies detected** | **83 / 83 (100%)** — transactions *and* master data |
| Canonical model invariants | **36 / 36 passing** |
...
snow sql -c <connection> -f sql/03_gold/03_validate_canonical.sql      # 36 invariants
```
